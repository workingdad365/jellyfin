...
namespace Jellyfin.Server.Implementations.Tests.Library
{
    public class IgnorePatternsTests
    {
        ...
        [InlineData("/media/movies/recycle/test.txt", true)]
        [InlineData("/media/movies/RECYCLE/test.txt", true)]
        [InlineData("Q:/#recycle/movie.mp4", true)]
        [InlineData("Q:/Movies/#recycle/test.mkv", true)]
        [InlineData("Z:/TV/#RECYCLE/show.mp4", true)]
        [InlineData(@"Q:\#recycle\movie.mp4", true)]
        [InlineData(@"Q:\Movies\#recycle\test.mkv", true)]
        [InlineData(@"Z:\TV\#RECYCLE\show.mp4", true)]
        [InlineData(@"C:\Media\#recycle\file.avi", true)]
        [InlineData("/media/movies/Recycled/test.txt", true)]
        [InlineData("/media/movies/RECYCLER/test.txt", true)]
        [InlineData("/media/movies/.Trash/test.txt", true)]
        [InlineData("/media/movies/Trash/test.txt", true)]
